    ...
    <div key={gen.id} className="mb-4 break-inside-avoid">
      <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/20 transition group">
        ...
        >
          ...
          {/* status badge */}
          <div className="absolute flex left-3 top-3 gap-2 items-center">
            {/* for generation */}
            {gen.isGenerating && (
        ...
        overflow-hidden right-0 peer-focus:block hover:block w-40
        bg-black/50 backdrop-blur text-white border border-gray-500/50
        rounded-lg shadow-md mt-2 py-1 z-10`}
                >
                  {/* menu options like share, download img or video */}
                  {gen.generatedImage && (
                    <a
                      href="#"
                      download
        ...
        <div className="p-4">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-400">
                Created: {new Date(gen.createdAt as string).toLocaleString()}
              </p>
              {gen.updatedAt && (
          ...
          {/* buttons for details and public */}
          {!forCommunity && (
