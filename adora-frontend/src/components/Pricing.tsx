    ...
    <section id="pricing" className="py-20 bg-white/3 border-t border-white/6">
      <div className="max-w-6xl mx-auto px-4">
        <Title
          ...
          description="Our pricing plans are simple, transparent and flexible. Choose the plan that fits your needs and scale as you grow."
        />
        ...
        <div className="flex flex-wrap items-center justify-center max-w-5xl mx-auto">
          <PricingTable
            appearance={{
              ...
              elements: {
                pricingTableCard: "bg-white/6",
                pricingTableCardHeader: "bg-white/6",
...
//         ) : (
//           <GhostButton className="w-full justify-center">Buy Now</GhostButton>
//         )}
//       </div>
//     </motion.div>
//   ));
